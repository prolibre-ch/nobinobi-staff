...
setup(
    ...
    url='https://homer.lan.prolibre.com:8400/projects/nobinobi-staff/',
    packages=[
        'nobinobi_staff',
    ],
    ...
    dependency_links=['ssh://gitolite@homer.lan.prolibre.com:8022/nobinobi-core/nobinobi-core/archive/master.tar.gz#egg=nobinobi-core-0.1.0'],
    zip_safe=False,
